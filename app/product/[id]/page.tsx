import SalesCampaignBanner from "@/app/components/layouts/SalesCampaignBanner";
    ...
    <div className="bg-gray-50">
      ...
      <div className="container mx-auto py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {/* Product image */}
          {product.image && (
            <div className="bg-white rounded-2xl p-4 aspect-square overflow-hidden shadow-lg max-w-[600px]">
